...
**Jira Ticket:** [LND-39](https://rohitroy007.atlassian.net/browse/LND-39)  
...
Problem Description:
Solve the Binary Tree Maximum Path Sum coding problem according to the LeetCode description.
...
- LeetCode Discussion: https://leetcode.com/problems/binary-tree-maximum-path-sum/discuss/
